...
cv2.imwrite('_1GF2_PMS1__L1A0001680858-MSS1_label.png',pre_y4)
...
b, g, r = cv2.split(pre_y3)
pre_y4 = cv2.merge([r, g, b])
cv2.imwrite('_1GF2_PMS2__L1A0000607677-MSS2_label.png',pre_y4)
...
b, g, r = cv2.split(pre_y3)
pre_y4 = cv2.merge([r, g, b])
cv2.imwrite('_1GF2_PMS2__L1A0000607681-MSS2_label.png',pre_y4)
